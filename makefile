...
SOURCES = quail.cpp ./src/lexer.cpp ./src/externs.cpp ./src/parser.cpp ./src/logging.cpp ./src/BinopsData.cpp ./src/codegen.cpp ./src/datatype.cpp ./src/optimizations.cpp
